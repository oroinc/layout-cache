...
namespace Oro\Bundle\LayoutCacheBundle\Tests\Functional\Layout;
 ...
 * @covers \Oro\Bundle\LayoutCacheBundle\Layout\CacheTwigRendererDecorator::searchAndRenderBlock
 * @covers \Oro\Bundle\LayoutCacheBundle\Layout\CacheLayoutBuilder
 */
class RendererTest extends LayoutTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->cache = $this->getContainer()->get('oro.layout_cache.tag_aware_cache_adapter');
        $this->cache->clear();
    }

    public function testLayoutBuilderIsDecorated(): void
    {
        $this->assertEquals(CacheLayoutBuilder::class, get_class($this->layoutManager->getLayoutBuilder()));
    }
